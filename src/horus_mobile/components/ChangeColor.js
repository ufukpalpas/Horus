    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ImageBackground resizeMode="cover" source ={require('../assets/background.jpeg')} style={styles.background}>
        <View
          ...
          />
          <TouchableOpacity  onPress={() => this.props.navigation.navigate('CurrentAnalysis', {newAngryColor: oldColor1, newDisgustColor: oldColor2,newFearColor: oldColor3, newHappyColor:oldColor4, newSadColor: oldColor5,newSurpriseColor:oldColor6,newNeutralColor:oldColor7})} > 
